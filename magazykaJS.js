...
var magazyka = {
    ...
    inBasket: function () {
        ...
        aa.setAttribute("href", "http://localhost:3000/somepage");
       ...
       // var $basketGO = $('#basketGO');
        //Навешивание обработчиков для перехода на страничку корзины
       /* $($basketGO).on('click', function () {

           // console.log('aada');
            document.location.href = "http://localhost:3000/somepage";
        });*/
